...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `crud`(`id`, `first_name`, `last_name`, `email`, `gender`) VALUES ('$id','$first_name','$last_name','$email','$gender')";
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3>Add New User</h3>
            <p class="text-muted">Complete the form to add a user</p>
        </div>
    </div>
